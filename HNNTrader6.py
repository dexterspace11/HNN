# ---------------- Full Updated Hybrid DNN-EQIC Streamlit App with Y-axis Padding -------------------
...
actual_close_placeholder = st.empty()
...
while True:
    ...
    # Display current actual close prominently
    actual_close_placeholder.markdown(f"### Current Actual Close: {actual_close:.2f}")
    ...
    with placeholder.container():
        ...
        # Dynamic y-axis padding for better visibility
