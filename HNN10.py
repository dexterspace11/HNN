...
# ===== Hybrid Neural Unit (DNN-EQIC) with enhancements =====
class HybridNeuralUnit:
    def __init__(self, position, learning_rate=0.1):
        self.position = position
        self.connections = {}
        self.learning_rate = learning_rate
        self.age = 0  # For pruning
        self.usage_count = 0
...
class HybridNeuralNetwork:
    def __init__(self):
        ...
        self.error_history = []
        self.feature_importance = np.zeros(4)
    ...
    def prune_units(self, max_age=20, min_usage=1):
        self.units = [unit for unit in self.units if unit.age < max_age or unit.usage_count > min_usage]
    ...
    def update_feature_importance(self, input_data, prediction):
        self.feature_importance += np.abs(input_data - prediction)
...
while True:
    ...
    with placeholder.container():
        ...
        # Show PCA and feature importance
