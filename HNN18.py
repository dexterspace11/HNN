# ✅ Full Hybrid DNN-EQIC BTC/USDT Predictor with Streamlit Visualization
...
while True:
    ...
    # Forward validation: compare previous prediction with actual close at that time
    if len(prediction_queue) > 1:
        prev_time, prev_pred = prediction_queue.pop(0)
        # Actual close corresponding to prev_time
