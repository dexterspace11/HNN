# ✅ Finalized Hybrid DNN-EQIC BTC/USDT Predictor with Accurate Forward Validation and Streamlit Charts
...
while True:
    ...
    input_data = data_scaled[-2]  # second-last input
    actual_time = df.index[-1]    # last actual close
