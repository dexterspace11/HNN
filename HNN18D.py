# ✅ Proactive Hybrid DNN-EQIC BTC/USDT Predictor with Streamlit and One-Step Ahead Forecasting
...
class HybridNeuralNetwork:
    ...
    def predict_next(self, input_data, smoothing_factor):
        ...
        if len(self.units) > 1:
            ...
            predicted += trend * 0.2  # Increased trend projection for proactive forecasting
...
while True:
    ...
    input_data = data_scaled[-1]  # Use last value for proactive one-step-ahead prediction
    ...
    with placeholder.container():
        ...
        col2.metric("Estimated Uncertainty", f"{network.estimate_uncertainty(similarity):.4f}")
